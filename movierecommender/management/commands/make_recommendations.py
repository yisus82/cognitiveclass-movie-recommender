...
def similarity_between_movies(movie1: Movie, movie2: Movie) -> float:
    if movie1.genres is None:
        movie1.genres = 'na'

    if movie2.genres is None:
        movie2.genres = 'na'
    ...
    def handle(self, *args, **kwargs):
        ...
        for unwatched_movie in unwatched_movies:
            ...
            for watched_movie in watched_movies:
                ...
                similarity = similarity_between_movies(
                    unwatched_movie, watched_movie)
            ...
            if max_similarity > THRESHOLD:
                will_recommend = True
                print(
                    f"Find a movie recommendation: {unwatched_movie.original_title}")
